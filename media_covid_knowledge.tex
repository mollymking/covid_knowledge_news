...
\usepackage{hyperref}
\hypersetup{
            pdftitle={Paying Attention to the Pandemic},
            pdfborder={0 0 0},
            breaklinks=true}
...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=.8\textwidth]{two-step-model-of-knowledge-2}
  \end{center}
...
% $$  ln \frac{P({y_{ij}}=1)}{P({y_{ij}}=0)} =\beta_{0i} + \beta_{edu}Education_i + \beta_{woman}Woman_i + β_{age}Age_i + \beta_{inc}Income_i + β_{black}Black_i + $$
